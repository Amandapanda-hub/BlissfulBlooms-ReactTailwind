  ...
  return (
    <div className="flex flex-col items-center justify-center w-full min-h-screen bg-[#F5F3F4] p-8 f-background">
      <div className="flex flex-col items-center justify-center space-y-8 w-full lg:w-1/2 mt-auto mb-auto pt-[7rem] ">
        ...
        <p className='text-2xl font-normal text-center tracking-wide w-full lg:w-[60%]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore.</p>
      ...
      <div className="flex flex-col items-center justify-center space-y-8 w-full lg:w-1/2 mt-auto mb-auto text-2xl">
      ...
      <div className="flex justify-around w-full lg:w-[50%] mt-auto mb-10 text-sm sm:text-base text-[#3F2305]">
