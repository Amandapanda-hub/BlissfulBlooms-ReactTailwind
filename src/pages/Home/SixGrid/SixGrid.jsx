...
const GridItem = ({ SvgComponent, title, description }) => (
    <div className="flex flex-col items-center mt-10 sm:mt-0">
      <div className="w-full h-full flex items-center justify-center">
        {/* <SvgComponent className="w-full min-w-fit md:h-[180px] lg:w-[100%] h-[200px] mx-auto" /> */}
        <SvgComponent className="w-3/5 sm:w-full md:min-w-fit md:min-h-fit lg:w-[100%] h-[200px] mx-auto" />

      </div>
      <h1 className="font-bold text-xl sm:text-2xl md:text-3xl text-center mt-8 h-[60px] tracking-wider">{title}</h1>
      <p className="text-center mt-0 sm:mt-1 text-md sm:text-lg font-medium w-full sm:w-80 mx-auto">{description}</p>
    </div>
);
...
const SixGrid = () => (
  <div className="flex flex-col items-center justify-center min-h-screen bg-[#ffe3e3] px-4 py-20">
    {/* <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:gap-10 lg:gap-20 mb-8 place-items-center"> */}
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:gap-18 lg:gap-20 mb-8">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 md:gap-18 lg:grid-cols-3 lg:gap-20 mb-8">
